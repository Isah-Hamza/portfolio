...
const Header = () => {
  ...
  return (
    <header className=' shadow-md mb-8 fixed w-full  z-20 bg-sky-200'>      
      <div className = 'flex justify-between w-full'>
        <div className = 'flex justify-between w-full md:w-auto py-4 px-4 bg-sky-200 items-center' >
          ...
          <div className='md:hidden flex cursor-pointer  -mr-1'>
        ...
        {/* nav for desktop */}
        <nav className= {`${ styles.nav } desktop hidden px-4 xxl:px-6 text-center bg-sky-200 flex-col md:flex md:flex-row `}>
